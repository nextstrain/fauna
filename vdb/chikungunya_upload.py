...
class chikungunya_upload(upload):
    def __init__(self, **kwargs):
        upload.__init__(self, **kwargs)
        self.strain_fix_fname = "source-data/chikungunya_strain_name_fix.tsv"
        # self.location_fix_fname = "source-data/chikungunya_location_fix.tsv"
        # self.date_fix_fname = "source-data/chikungunya_date_fix.tsv"
...
if __name__=="__main__":
    ...
    # 0        1          2  3          4     5     6  7
    #>MH423797|027_16_S43|NA|2016_05_07|Human|Kenya|NA|Chikungunya_virus
    setattr(args, 'virus_fasta_fields', virus_fasta_fields)
    setattr(args, 'sequence_fasta_fields', sequence_fasta_fields)
    connVDB = chikungunya_upload(**args.__dict__)
