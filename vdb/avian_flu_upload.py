...
class flu_upload(upload):
    ...
    def format_host(self, v):
        ...
        avian_list = [
            ...
            "ansercygnoides","anasplatyrhynchosf.domestica",
            ...
            "avian", "bar__headed__goose", "beangoose","bird",
            ...
            "green-wingedteal", "grey__heron", "guineafowl", "gull","halietusleucocephalus",
            ...
            "quail", "ring-neckedduck","rook", "ruddy__turnstone", "ruddyturnstone",
