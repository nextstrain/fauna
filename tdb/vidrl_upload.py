...
def parse_human_serum_id(original_id: str, year_regex: str) -> Optional[Tuple[str,str]]:
    """
...
def curate_flat_records(records: Iterator[dict], fstem: str, assay_type: str) -> Iterator[dict]:
    ...
    column_map = {
        ...
        "reference passage": "serum_passage",
        "ferret": "serum_id",
        "titre": "titer",
        "antisera": "serum_abbr",
        "test date": "date",
    ...
    for record in records:
        ...
        if new_record["serum_id"] == "NA":
            ...
            _, new_record["serum_id"] = parse_human_serum_id(new_record["serum_abbr"], HUMAN_SERA_YEAR_REGEX)
